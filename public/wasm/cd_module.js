...
async function CdModule(moduleArg = {}) {
  var moduleRtn;
...
function findWasmBinary() {
  if (Module['locateFile']) {
    return locateFile('cd_module.wasm');
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('cd_module.wasm', import.meta.url).href;
}
...
function em_debug_stream(msg) { console.log("debug: " + UTF8ToString(msg)); }
function em_info_stream(msg) { console.log("info: " + UTF8ToString(msg)); }
function em_warning_stream(msg) { console.warn("warning: " + UTF8ToString(msg)); }
function em_error_stream(msg) { console.error("error: " + UTF8ToString(msg)); }
